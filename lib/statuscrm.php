...
class StatuscrmTable extends DataManager
{
    // название таблицы
    ...
    public static function getMap()
    {
        return array(
            ...
            new StringField('COLOR', array(
                'required' => false,
                'title' => Loc::getMessage('MYMODULE_COLOR'),
                'default_value' => function () {
                    return Loc::getMessage('MYMODULE_COLOR_DEFAULT_VALUE');
                },
                'validation' => function () {
                    return array(
                        new Validator\Length(null, 255),
